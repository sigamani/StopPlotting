 ...
 if ( isBDT  == true) { 
		...
		if (EXP =="Exp"){
					...
					if (EXP =="ObsM"){
						...
						if (( x ==225.) && ( y==0.) ) limit= 0.9;
						if (( x ==150.) && ( y==25.) ) limit= 0.9;
						if (( x ==650.) && ( y==25.) ) limit= 0.9;
						if (( x ==625.) && ( y==200.) ) limit= 0.9;
						if (( x ==175.) && ( y==50.) ) limit= 0.9;
						if (( x ==575.) && ( y==100.) ) limit= 0.9;
						if (( x ==525.) && ( y==225.) ) limit= 0.9;
