...
dataset_name 		= ['DoubleElec', 'DoubleMuon', 'MuEl', 'rare', 'ttbar_powheg', 'ttbar_madgraph_2l',] 
outputEOSdir		= "/eos/cms/store/caf/user/sigamani/StopBabies/V00-06/fix2lepton/"


for z in range(len(dataset_name)):

    outputdir = pwd+"/batch_output3/"+dataset_name[z] 
    ...
    outputfile.write("./runExtender /afs/cern.ch/user/a/aaubin/work/public/stopBabies_1030/fix2lepton/"+dataset_name[z]+".root /tmp/sigamani/"+dataset_name[z]+".root met,lepton_pT,njets,mlb_hemi,m3b,mT2W,b1_pt,dPhi_JetMet,dR_LepB met,lepton_pT,njets,mlb_hemi,m3b,mT2W,dR_LepB,dPhi_JetMet,b1_pt met,lepton_pT,njets,jet1_pT,HT,mlb_hemi,m3b,mT2W,dPhi_JetMet met,lepton_pT,mlb_hemi,HTfrac,njets,dPhi_JetMet,b1_pt met,mT2W,HTfrac,njets,dPhi_JetMet,lepton_pT,dR_LepB,Chi2SNT,jet1_pT; \n")
